 ...
 *
 * ## OTel
 * Logcat debug logging is always enabled so spans are visible without an external collector.
...
class SampleApplication : Application() {
    ...
    private fun initMicroCoachingSDK() {
        ...
        // OTel: real endpoint if OTEL_ENDPOINT is set in local.properties; Logcat always on.
        ...
        val sdk = MicroCoachingSDK.Builder(this)
            ...
            .enableOtelDebugLogging(true)   // always log spans to Logcat for dev visibility
            // Model
