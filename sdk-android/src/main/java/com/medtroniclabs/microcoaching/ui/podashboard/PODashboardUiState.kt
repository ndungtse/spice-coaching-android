...
sealed class PODashboardUiState {
    ...
    data class Error(val message: String, val isAuth: Boolean = false) : PODashboardUiState()
...
sealed class SkDetailUiState {
    ...
    data class Error(val message: String, val isAuth: Boolean = false) : SkDetailUiState()
