...
fun CoachingHomeHost(
    ...
    onOpenActiveSks: (com.medtroniclabs.microcoaching.ui.podashboard.SkStatus, com.medtroniclabs.microcoaching.ui.podashboard.DateRange) -> Unit = { _, _ -> },
    onOpenChatbotUsage: (com.medtroniclabs.microcoaching.ui.podashboard.DateRange) -> Unit = {},
    onOpenModulesCompleted: (com.medtroniclabs.microcoaching.ui.podashboard.DateRange) -> Unit = {},
    onOpenSkDetail: (String, com.medtroniclabs.microcoaching.ui.podashboard.DateRange) -> Unit = { _, _ -> },
    onOpenSearchedModule: (String, com.medtroniclabs.microcoaching.ui.podashboard.DateRange) -> Unit = { _, _ -> },
    onOpenSuggestion: (String) -> Unit = {},
    onOpenDocument: (String, com.medtroniclabs.microcoaching.ui.podashboard.DateRange) -> Unit = { _, _ -> },
